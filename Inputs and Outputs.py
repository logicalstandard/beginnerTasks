...
def problem5():
    ...
    print(f"Your score is {str(task5_percentage)}%")
...
def problem8():
    ...
    print(f"{str(task8_num1)} is {str(task8_percentage)}% of {str(task8_num2)}")
...
def problem9():
    ...
    print(f"{task9_item1} and {task9_item2} will cost £{str(task9_totalPrice)}")
...
def problem10():
    ...
    print(f"When {task10_name} is {str(task10_newAge)} years old, he will be approximately {str(task10_newHeight)} centimetres tall.")
...
def main():
    while True:
        ...
        problems = {1:problem1, 2:problem2, 3:problem3, 4:problem4, 5:problem5, 6:problem6, 7:problem7, 8:problem8, 9:problem9, 10:problem10}
        problem = problems.get(choice, "This is not a valid choice. Please select a number from 1-10")
        problem()
